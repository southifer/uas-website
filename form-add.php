...
<html lang="en" data-bs-theme="dark">
    ...
    <body>
        ...
        <div class="container">
            <br>
            <h3 class="text-center"><b>Halaman Admin</b></h3>
            <br><br>
            <form method="post" action="form-add-process.php" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Game Banner</label>
                    <textarea class="form-control" id="banner" name="banner" rows="3"></textarea>
                </div>
                <div class="mb-3">
