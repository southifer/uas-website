...
<html lang="en" data-bs-theme="dark">
    ...
    <body>
        ...
        <div class="container">
            ...
            ?>
            <form method="post" action="data-edit-process.php" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-select mb-3" aria-label="Large select example" id="level" name="level">
                        <option selected>Open this select menu</option>
                        <option value="1" <?= $row['level'] == "1" ? "selected" : "" ?>>Administrator</option>
                        <option value="0" <?= $row['level'] == "0" ? "selected" : "" ?>>None</option>
                    </select>
                </div>
